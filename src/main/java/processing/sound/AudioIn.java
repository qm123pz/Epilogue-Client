...
/**
 * AudioIn lets you grab the audio input from your processing.sound card.
 * 
 * @webref I/O:AudioIn
 * @webBrief AudioIn lets you grab the audio input from your processing.sound card.
 **/
public class AudioIn extends SoundObject {
	...
	/**
	 * Stop capturing processing.sound from this audio input.
	 *
	 * @webref I/O:AudioIn
	 **/
	public void stop() {
