...
public abstract class MultiChannel {
	...
	/**
	 * Finds the audio device (processing.sound card) with the highest number of output
	 ...
	 *
	 * @webref I/O:MultiChannel
	 * @see processing.sound.Sound#list()
	 * @see processing.sound.Sound#outputDevice()
	 * @see MultiChannel#availableChannels()
	 */
	public static int autoSelectDevice(int minChannels) {
		int[] candidates = IntStream.range(0, processing.sound.Sound.getAudioDeviceManager().getDeviceCount())
	...
	public static int autoSelectDevice() {
		...
		int nChannels = IntStream.range(0, processing.sound.Sound.getAudioDeviceManager().getDeviceCount())
	 ...
	 *
	 * @webref I/O:MultiChannel
	 * @see processing.sound.Sound#outputDevice(int)
	 * @see processing.sound.Sound#list()
	 */
