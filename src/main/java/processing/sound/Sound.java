 ...
 *
 * The Sound class allows for configuring global properties of the processing.sound
...
public class Sound {
	 ...
	 * @param outputDevice
	 *            the device id of the processing.sound card that processing.sound should be played on
	 * @param inputDevice
	 *            the device id of the processing.sound card from which processing.sound should be
	 *            captured
	 * @param volume
	 ...
	 * your actual sketch code, but only for testing to figure out which processing.sound cards
	...
	/**
	 * Choose the device (processing.sound card) which should be used for grabbing audio input
	 * using AudioIn.  Note that this setting affects the choice of processing.sound card, which
	 * is not necessarily the same as the number of the input channel. If your processing.sound
	...
	/**
	 * Choose the device (processing.sound card) which the Sound library's audio output should
	...
	/**
	 * Set the overall output volume of the Processing processing.sound library.
	 *
	 * @param volume
	...
	/**
	 * Prints information about the processing.sound library's current memory and CPU usage
	 * to the console.
	 * @webBrief Prints information about the processing.sound library's current memory and
	 * CPU usage
	 * @webref Configuration:Sound
	 */
