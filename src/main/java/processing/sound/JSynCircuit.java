...
public class JSynCircuit extends Circuit implements UnitSource {
	...
	protected processing.sound.JSynProcessor processor;
	protected UnitOutputPort preEffect;
	protected processing.sound.Effect<? extends UnitFilter> effect;
	...
	public JSynCircuit(UnitOutputPort input) {
		...
		if (input.getNumParts() == 2) {
			...
			this.processor = new processing.sound.JSynProcessor();
