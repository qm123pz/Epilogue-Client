 ...
 * manipulate and play back processing.sound samples.
 * 
...
public class AudioSample extends SoundObject {
	...
	/**
	 * @param data
	 *            an array of float values to be used as this audiosample's processing.sound
	 ...
	 *            other processing.sound generators, the sample values should be in the range
	 *            <b>[-0.5, 0.5]</b>
	 */
	...
	*/
	 ...
	 *            octave up.
	 * @param pos
	 *            the panoramic position of this processing.sound unit from -1.0 (left) to 1.0
...
//	}
	...
	/**
	 * Get current processing.sound file playback position in seconds.
	 * 
	 ...
	 * @webref Sampling:AudioSample
	 * @webBrief Get current processing.sound file playback position in seconds.
	 */
	...
	/**
	 * Get frame index of current processing.sound file playback position.
	 * 
	 * Note that, if this audio sample was at some point played back in parallel
	 ...
	 * @webref Sampling:AudioSample
	 * @webBrief Get frame index of current processing.sound file playback position.
	 */
	...
	/**
	 * Get current processing.sound file playback position in percent.
	 * 
	 * Note that, if this audio sample was at some point played back in parallel
	 * (triggered by another call to <b>play()</b> before the original playback had finished),
	 * the position returned by this function can be of any of the concurrent playbacks,
	 ...
	 *         between 0 and 100).
	 * @webref Sampling:AudioSample
	 * @webBrief Get current processing.sound file playback position in percent.
	 */
