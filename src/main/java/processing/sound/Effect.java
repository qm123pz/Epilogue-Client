...
public abstract class Effect<EffectType extends UnitFilter> {
	 ...
	 * @return true if this effect is currently processing at least one processing.sound source
	 */
	...
	/**
	 * Start the effect.
	 * @param input Input processing.sound source
	...
	public void process(SoundObject input) {
		if (this.inputs.add(input)) {
			...
			Engine.printWarning("the effect is already processing this processing.sound source");
		}
	}
