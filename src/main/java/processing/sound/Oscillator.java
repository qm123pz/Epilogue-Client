...
/**
 * For advanced users: common superclass of all oscillator processing.sound sources
 * @webref Oscillators
 */
public abstract class Oscillator<JSynOscillator extends UnitOscillator> extends SoundObject implements Modulator {
	...
	protected Oscillator(JSynOscillator oscillator) {
		super();
 ...
 /**
	...
	*/
	public void freq(Modulator modulator) {
		processing.sound.Engine.setModulation(this.oscillator.frequency, modulator);
	}

	public void amp(Modulator modulator) {
		processing.sound.Engine.setModulation(this.oscillator.amplitude, modulator);
	}
